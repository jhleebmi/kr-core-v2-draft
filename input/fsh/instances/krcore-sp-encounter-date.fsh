Instance: krcore-sp-encounter-date
InstanceOf: SearchParameter
Title: "krcore-sp-encounter-date"
Description: "내원 기간 내 날짜"
Usage: #definition
* url = "http://www.hl7korea.or.kr/fhir/krcore/SearchParameter/krcore-sp-encounter-date"
* version = "1.0.2"
* name = "KRCoreSearchParameterEncounterDate"
