Instance: krcore-sp-procedure-date
InstanceOf: SearchParameter
Title: "krcore-sp-procedure-date"
Description: "수술 및 처치 수행 일시"
Usage: #definition
* url = "http://www.hl7korea.or.kr/fhir/krcore/SearchParameter/krcore-sp-procedure-date"
* version = "1.0.2"
* name = "KRCoreSearchParameterProcedureDate"
